...
var end_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>Vielen Dank, du hast diese Aufgabe abgeschlossen!</p><p class = center-block-text>Bitte drücke <strong>Enter</strong>.</p></div>',
  cont_key: [13],
  timing_response: 180000,
  timing_post_trial: 0
};
